...
const Listing1 = () => {
  ...
  return (
    <div className="relative bg-snow w-full h-[812px] overflow-hidden text-center text-smi text-black font-league-spartan">
      ...
      <img
        className="absolute top-[418px] left-[167px] w-2.5 h-2.5 object-cover"
        alt=""
        src="/image-26@2x.png"
      />
      <img
      ...
      <div className="absolute top-[444px] left-[40px] leading-[19px] font-extralight text-left inline-block w-[283px] h-[47px]">
        Large double room in central Manchester in a quiet residential flat. You
        are welcome to use the bathroom and the room comes with a secure lock.
      </div>
      ...
      <img
        ...
        src="/line-2.svg"
      />
      <div className="absolute top-[766px] left-[0px] w-[375px] h-[46px] overflow-hidden text-3xs">
