...
const Listing2 = () => {
  ...
  return (
    <div className="relative bg-snow w-full h-[812px] overflow-hidden text-center text-smi text-black font-league-spartan">
      ...
      <img
        className="absolute top-[418px] left-[166px] w-2.5 h-2.5 object-cover"
        alt=""
        src="/image-26@2x.png"
      />
      <img
      ...
      <img
        ...
        src="/image-27@2x.png"
      />
      <div className="absolute top-[444px] left-[40px] leading-[19px] font-extralight text-left inline-block w-[283px] h-[47px]">{`Family home in Salford with one young child and a small dog. Pets welcome.  `}</div>
      ...
      <img
        ...
        src="/line-2.svg"
      />
      <div className="absolute top-[766px] left-[3px] w-[375px] h-[46px] overflow-hidden text-3xs">
