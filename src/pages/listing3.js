...
const Listing3 = () => {
  ...
  return (
    <div className="relative bg-snow w-full h-[812px] overflow-hidden text-center text-smi text-black font-league-spartan">
      ...
      <img
        className="absolute top-[418px] left-[161px] w-2.5 h-2.5 object-cover"
        alt=""
        src="/image-26@2x.png"
      />
      <img
      ...
      <img
        ...
        src="/image-27@2x.png"
      />
      <div className="absolute top-[444px] left-[40px] leading-[19px] font-extralight text-left inline-block w-[283px] h-[47px]">{`Clean and tidy single room in a small and quiet house close to Manchester City Centre. `}</div>
